...
<header>
    ...
    <div class="wsus__mini_cart">
        ...
        <ul class="mini_cart_wrapper">
            @foreach($cartItems = Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{ $sidebarProduct->rowId }}">
                    <div class="wsus__cart_img">
                        <a href="{{ route('product-detail', $sidebarProduct->options->slug) }}"><img src="{{ asset($sidebarProduct->options->image) }}" alt="{{ $sidebarProduct->name }}" class="img-fluid w-100"></a>
