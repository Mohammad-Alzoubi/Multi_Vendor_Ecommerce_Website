                ...
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        @foreach($categories as $category)
                            <li><a class="{{ count($category->subCategories) ? 'wsus__droap_arrow':''}}" href="#"><i
...
<section id="wsus__mobile_menu">
    ...
    <ul class="wsus__mobile_menu_header_icon d-inline-flex">
        ...
        <li><a href="#"><i class="far fa-heart"></i> <span>2</span></a></li>

        <li><a href="#"><i class="far fa-random"></i> </i><span>3</span></a></li>
    </ul>
    <form>
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <ul class="wsus_mobile_menu_category">
                        @foreach($categories as $categoryItem)
                            <li><a href="#" class=" {{count($categoryItem->subCategories) ? 'accordion-button' :'' }} collapsed" data-bs-toggle="collapse"
                                   ...
                                   aria-controls="flush-collapseThreew-{{$loop->index}}"><i class="{{$categoryItem->icon}}"></i>
                                    {{$categoryItem->name}}</a>
                                @if(count($categoryItem->subCategories))
