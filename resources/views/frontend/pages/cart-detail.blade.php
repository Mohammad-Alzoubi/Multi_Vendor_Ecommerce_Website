                            ...
                            <table>
                                ...
                                <tr class="d-flex">
                                    ...
                                    <th class="wsus__pro_icon">
                                        @if(count($cartItems) === 0)
                                            <a class="common_btn" >clear cart</a>
                                        @else
                                ...
                                <tr class="d-flex">
                                    ...
                                    <td class="wsus__pro_name">
                                        <p>{!! $item->name !!}</p>
                                        @foreach($item->options->variants as $kay => $variant)
                                        <span>{{$kay}}: {{ $variant['name'] }}  ({{ $settings->currency_icon . $variant['price'] }}) </span>
                                        @endforeach
                                    </td>
                                    ...
                                    <td class="wsus__pro_icon">
                                        <a href="{{ route('cart.remove-product', $item->rowId) }}" class="remove-product"><i class="far fa-times"></i></a>
                                    </td>
                                </tr>
                                @endforeach
    ...
    $(document).ready(function (){
        ...
        function renderCartSubTotal(){
            $.ajax({
                ...
                success: function (data) {
                    let subtotalAmount = "{{ $settings->currency_icon }}" + data
                    $('#sub_total').text(subtotalAmount);
                },
                error: function (data) {
                    console.log(data)
                }
