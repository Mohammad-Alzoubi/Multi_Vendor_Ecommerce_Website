...
@section('content')
    ...
    <section id="wsus__product_details">
        <div class="container">
                        ...
                        <div id="sticky_pro_zoom">
                            <div class="exzoom hidden" id="exzoom">
                                <div class="exzoom_img_box">
                                    ...
                                    <a class="venobox wsus__pro_det_video" data-autoplay="false" data-vbtype="video"
            ...
            <!-- Description | Vendor Info | Reviews -->
            <div class="row">
                <div class="col-xl-12">
    ...
    <script>
        $(document).ready(function (){
            ...
            simplyCountdown('.simply-countdown-one', {
                year: {{date('Y', strtotime($product->end_date))}},
                month: {{date('m', strtotime($product->end_date))}},
                day: {{date('d', strtotime($product->end_date))}},
                // enableUtc: true
            });
        })
    </script>
