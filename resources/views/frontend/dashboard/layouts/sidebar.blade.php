<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
        ...
        <li><a class="" href="#"><i class="far fa-cloud-download-alt"></i> Downloads</a></li>
        <li><a class="" href="#"><i class="far fa-star"></i> Reviews</a></li>
        <li><a class="" href="#"><i class="far fa-heart"></i> Wishlist</a></li>
        <li><a class="{{ setActive(['user.profile']) }}" href="{{route('user.profile')}}"><i class="far fa-user"></i> My Profile</a></li>
        <li><a class="{{ setActive(['user.address.index', 'user.address.create']) }}" href="{{ route('user.address.index') }}"><i class="fal fa-gift-card"></i> Addresses</a></li>
        <li>
            <!-- Authentication -->
