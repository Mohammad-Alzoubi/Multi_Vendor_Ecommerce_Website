...
use App\Http\Controllers\Backend\FlashSale\FlashSaleController;
...
/** Order routes */
Route::get('payment-status', [OrderController::class, 'changePaymentOrderStatus'])->name('payment.status');
